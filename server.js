...
// Hook Swagger UI
app.use('/api-docs-contacts', swaggerUi.serve, swaggerUi.setup(contactsSwaggerFile)); // contacts API
app.use('/api-docs-books', swaggerUi.serve, swaggerUi.setup(booksSwaggerFile)); // books API
